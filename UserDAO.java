...
public class UserDAO {
    public static boolean validateUser(User user)throws SQLException
    {
        ...
        PreparedStatement ps=conn.prepareStatement("Select * from Login where userid=? and password=? and usertype=?");
    ...
    {
        String qry = "Select * from login where userid=?";
        boolean status = true;
        Connection conn = DBConnection.getConnection();
    ...
    {
        String qry = "Update login set password=? where userId =?";
        boolean status = true;
        Connection conn = DBConnection.getConnection();
        PreparedStatement ps = conn.prepareStatement(qry);
